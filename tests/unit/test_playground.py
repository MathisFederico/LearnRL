...
def test_agent_order():
    ...
    assert pg.agents_order == list(range(n_agents)), \
        f"Default agents_order shoud be {list(range(n_agents))} but was {pg.agents_order}"
    ...
    assert pg.agents_order == custom_order, \
        f"Custom agents_order shoud be {custom_order} but was {pg.agents_order}"
    ...
    assert pg.agents_order == new_custom_order, \
        f"Custom agents_order shoud be {new_custom_order} but was {pg.agents_order}"
